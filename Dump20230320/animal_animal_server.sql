...
CREATE TABLE `animal_server` (
  `animal_server_id` int NOT NULL AUTO_INCREMENT,
  `servers` varchar(45) NOT NULL,
  PRIMARY KEY (`animal_server_id`)
...
INSERT INTO `animal_server` VALUES (1,'Antartica'),(2,'Asia'),(3,'Arctic'),(4,'Australia'),(5,'Europe'),(6,'North America'),(7,'Ocean'),(8,'South America');
