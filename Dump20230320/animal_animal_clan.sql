...
CREATE TABLE `animal_clan` (
  `animal_clan_id` int NOT NULL AUTO_INCREMENT,
  `animal_clan` varchar(45) NOT NULL,
  `guilds` int NOT NULL,
  PRIMARY KEY (`animal_clan_id`),
  KEY `guilds_idx` (`guilds`)
...
INSERT INTO `animal_clan` VALUES (1,'Myxiniformes (Hagfish)',0),(2,'Petromyzontiformes (Lampreys)',0),(3,'Selachimorpha (Sharks)',0),(4,'Batoidea (Rays)',0);
